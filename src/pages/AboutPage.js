            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1">
                ...
                <p className="text-xl text-gray-300 mb-6 leading-relaxed">
                  Techblazers is proudly supported by STMicroelectronics, a global leader in semiconductors and embedded systems. This partnership enables us to work with cutting-edge technology and provides our interns with industry-leading tools and mentorship.
                </p>
